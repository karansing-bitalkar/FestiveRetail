...
const DEMO_DISPLAY = [
  { role: 'customer', label: 'Customer', icon: User, color: 'from-orange-500 to-pink-500', desc: 'Buyer Account' },
  { role: 'vendor', label: 'Vendor', icon: Store, color: 'from-purple-500 to-blue-500', desc: 'Seller Account' },
  { role: 'admin', label: 'Admin', icon: ShieldCheck, color: 'from-red-500 to-orange-500', desc: 'Admin Panel' },
];
